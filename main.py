...
def generate_biology_quizzes():
    prompt = """
    Biologiya fanidan 5 ta mutlaqo yangi test savolini JSON formatida yaratib ber.
    Javob FAQAT quyidagi strukturadagi JSON ro'yxati bo'lsin:
    [
      {
        "q": "Savol matni",
    ...
    Eslatib o'tamiz: "c" kodi to'g'ri javobning indeksi (0, 1, 2 yoki 3). Hech qanday qo'shimcha matn yozma.
    """
    try:
        ...
        # Zaxira savollari (Xatolik bo'lsa ishlaydi)
        return [
...
async def start_cmd(message: types.Message):
    ...
    # Sun'iy intellektdan yangi savollar olish
